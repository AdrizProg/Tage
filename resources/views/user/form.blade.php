<div class="space-y-6">
    ...
    <div>
        ...
        <x-text-input id="centro" name="centro" type="text" class="mt-1 block w-full" :value="old('centro', $user?->centro)" autocomplete="centro" placeholder="Centro"/>
        <x-input-error class="mt-2" :messages="$errors->get('centro')"/>
    </div>
